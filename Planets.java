...
public class Planets extends CreatePlanet{
    ...
    public static void main(String[] args) {
        ...
        String item2 = randomItems(items);
        String item3 = randomItems(items);
        String item4 = randomItems(items);
        String item5 = randomItems(items);
        String item6 = randomItems(items);
        
        //start defining what will show in GUI for each planet, randomly determined w/ arrayLists
